...
public class clineView  extends HttpServlet{
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		htmlChuyenbay chuyenbay = new htmlChuyenbay(duongbay);
		htmlBay=chuyenbay.getHtmlBay();
		htmlBanner htmlBan = new htmlBanner();
		htmlbn = htmlBan.getHtmlBanner();
		htmlKhachsan htmlksan = new htmlKhachsan(diadiem);
	...
	htmldn="  <form action='' class='form1 dangnhapwi showdangnhap'  id='dangnhap-menu' >\r\n"
		...
		pw.println("<!DOCTYPE html>\r\n"
				...
				+ "                    <div > <input type='text' value='' name='timdiadiem' placeholder='Địa điểm...'  class='nuttk'> </div> \r\n"
				...
				+ "                                                <div><span class='tien'>VNĐ</span><span class='amount'>1.575.000</span></div>\r\n"
				+ "                                            </div>\r\n"
				+ "                                        </div>\r\n"
				+ "                                    </div>\r\n"
				+ "                                    <div class='py-2 px-3'>\r\n"
