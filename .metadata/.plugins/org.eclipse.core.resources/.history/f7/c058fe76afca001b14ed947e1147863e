...
+ "                </section>"
				...
				+ "                    <h3><a style='background-color: #09011f;padding: 5px;border-radius: 10px;cursor:pointer;color: #ffffff;'  onclick='myFunction2()'>Tìm kiếm</a> chuyến bay mà bạn muốn  "
				+ "\r\n"
				+ "                    </h3>\r\n"
...
+ "                <h1>Tìm hiểu thêm những gì là tốt nhất</h1>\r\n"
...
+ "            </section>"
				...
				+ "             \r\n"
				+ "                                            <h4>Mùa Hè</h4>\r\n"
				+ "                                            <p>Chúng tôi sẽ đồng hành cùng gia đình bạn</p> <br> <a href='#' >TÌM HIỂU THÊM</a>\r\n"
				+ "                                        </div>\r\n"
